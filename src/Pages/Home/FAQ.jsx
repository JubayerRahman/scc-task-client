...
const FAQ = () => {
  ...
  return (
                <div data-aos="fade-up"  className='aboutus p-[10px] flex flex-col gap-3 text-white'>
                    <h1 className='text-3xl lg:text-5xl font-[500] my-[50px] text-[#BF3DE2]'>FAQ about us:</h1>
                <div className='flex flex-wrap justify-evenly gap-3 mx-auto'>
                <div className=" bg-opacity-[0.6] lg:w-[45%] collapse bg-[#BF3DE2]">
